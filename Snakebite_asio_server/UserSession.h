...
private:
	...
	// Service을(를) 통해 상속됨
	virtual acoross::rpc::ErrCode InitPlayer(const acoross::snakebite::messages::InitPlayerSnakeRequest &rq, acoross::snakebite::messages::InitPlayerSnakeReply *rp);
	virtual acoross::rpc::ErrCode SetKeyDown(const acoross::snakebite::messages::TurnKeyDownRequest &rq, acoross::snakebite::messages::VoidReply *rp);
	virtual acoross::rpc::ErrCode SetKeyUp(const acoross::snakebite::messages::TurnKeyUpRequest &rq, acoross::snakebite::messages::VoidReply *rp);
	virtual acoross::rpc::ErrCode ListenGameObjectUpdateEvent(const acoross::snakebite::messages::ListenGameObjectUpdateRequest &rq, acoross::snakebite::messages::UpdateGameObjectsEvent *rp);
};
